...
import com.example.sslost.main.search.SearchActivity;
import com.example.sslost.main.slider.indicator.PageIndicator;
import com.example.sslost.main.slider.recycle.RecyclingPagerAdapter;
import com.example.sslost.main.slider.recycle.RecyleAdapter;
...
public class InfiniteIndicator extends RelativeLayout implements
     ...
     * start auto scroll
     *
     * @ delayTimeInMills first scroll delay time,default is 2500ms
     */
    public void start() {
