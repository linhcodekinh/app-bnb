...
public class RatingDialog extends Dialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    private void init() {
        ...
        tvNegative.setTextColor(builder.negativeTextColor != 0 ? ContextCompat.getColor(context, builder.negativeTextColor) : ContextCompat.getColor(context, R.color.notification_icon_bg_color));
        ...
        tvCancel.setTextColor(builder.negativeTextColor != 0 ? ContextCompat.getColor(context, builder.negativeTextColor) : ContextCompat.getColor(context, R.color.notification_icon_bg_color));
